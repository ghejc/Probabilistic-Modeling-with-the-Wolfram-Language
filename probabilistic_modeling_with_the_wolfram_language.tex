...
The Bayes filter framework is the conceptual basis of a large number of existing models like Kalman and Particle filters, Hidden Markov Models (see next example), Dynamic Bayesian Networks (basically the introduction to this chapter) and Markov Decision Processes with a wide range of applications.
