...
Trajectory[initialPosition_, initialSpeed_, initialTime_, numberOfCollisions_,
   ...
   (* The trajectory is calculated by applying the function Propagate
      several times starting with the initial state. *)
   trajectory = NestList[Propagate, 
...
trajectory = Trajectory[{0, 0}, {0.1, 0.2}, 0, 9, boundaries];
