...
In the Wolfram Language a random walk sequence can be generated with the function \texttt{RandomWalkProcess}. The output of an own implementation using \texttt{NestList} and \texttt{RandomChoice} is compared to the sequence generated with the internal function.

\begin{mathematica}
data1 = RandomFunction[RandomWalkProcess[.5], {0, 1000}];
data2 = NestList[# + RandomChoice[{1, -1}] &, 0, 1000];
