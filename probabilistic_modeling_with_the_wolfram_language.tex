...
PDF[dist, y]
\end{mathematica}
Note that the second argument to \texttt{NormalDistribution} is the standard deviation $\sigma$, not the variance $\sigma^2$. The singular value at $y=0$ will be shown as \texttt{Indeterminate}.
\end{example}  
