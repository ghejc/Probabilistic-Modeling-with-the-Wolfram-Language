...
\begin{exercise}
At $t_5$ the result is that state c, d and g have the same probability and as we see from the timeline graph, the system is in state c.

\includegraphics[scale=0.9, center]{images/state_estimate_t5.pdf}

Analyze this situation and come up with an explanation, why the system state cannot be predicted unambiguously in this case. 
\end{exercise}
